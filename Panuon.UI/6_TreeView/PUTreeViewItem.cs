...
namespace Panuon.UI
{
    public class PUTreeViewItem : TreeViewItem
    {
        ...
        public static readonly DependencyProperty InnerHeightProperty = DependencyProperty.Register("InnerHeight", typeof(double), typeof(PUTreeViewItem), new PropertyMetadata((double)30));
        ...
        public static readonly DependencyProperty CoverBackgroundProperty = DependencyProperty.Register("CoverBackground", typeof(SolidColorBrush), typeof(PUTreeViewItem), new PropertyMetadata(new SolidColorBrush((Color)ColorConverter.ConvertFromString("#22666666"))));
